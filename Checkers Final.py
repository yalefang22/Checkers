        ...
        if not self.check:
            ...
            if self.piece == 'blackking':
                ...
                if self.e2['image'] == 'pyimage7':
                    self.e2.configure(image=self.transparent)
                    self.d3.configure(image=self.transparent)
                if self.a2['image'] == 'pyimage7' and self.b3['image'] == 'pyimage1':
                    self.a2.configure(image=self.transparent)
                    self.b3.configure(image=self.transparent)
            self.piece = ''
            self.check = False
        ...
        if not self.check:
            ...
            if self.piece == 'red' or self.piece == 'redking' or self.piece == 'blackking':
                if self.piece == 'redking':
                    ...
                    if self.d7['image'] == 'pyimage1' or self.e6['image'] == 'pyimage3':
                        self.ablee6 = True
                    else:
                        self.ablee6 = False
                if self.d7['image'] != 'pyimage3':
        ...
        if not self.check:
            ...
            if self.piece == 'red':
                ...
                if self.b7['image'] == 'pyimage7':
                    self.b7.configure(image=self.transparent)
                    self.c6.configure(image=self.transparent)
                if self.b3['image'] == 'pyimage7' and self.c4['image'] == 'pyimage3':
                    self.b3.configure(image=self.transparent)
                    self.c4.configure(image=self.transparent)
        ...
        if not self.check:
            ...
            if self.piece == 'red':
                ...
                if self.c2['image'] == 'pyimage7':
                    ...
                    self.c6.configure(image=self.transparent)
                    self.d5.configure(image=self.transparent)
                elif self.g2['image'] == 'pyimage7' and self.f3['image'] == 'pyimage1':
                    self.g2.configure(image=self.transparent)
                    self.f3.configure(image=self.transparent)
                elif self.g6['image'] == 'pyimage7' and self.f5['image'] == 'pyimage1':
                    self.g6.configure(image=self.transparent)
                    self.f5.configure(image=self.transparent)
            self.piece = ''
            self.check = False
        ...
        if not self.check:
            ...
            if self.piece == 'red':
                ...
                if self.g2['image'] == 'pyimage7':
                    self.g2.configure(image=self.transparent)
                if self.d3['image'] == 'pyimage7' and self.e2['image'] == 'pyimage2':
                    self.d3.configure(image=self.transparent)
                    self.e2.configure(image=self.transparent)
                if self.h3['image'] == 'pyimage7' and self.g2['image'] == 'pyimage2':
                    self.h3.configure(image=self.transparent)
                    self.g2.configure(image=self.transparent)
            elif self.piece == 'blackking':
                ...
                if self.g2['image'] == 'pyimage7':
                    self.g2.configure(image=self.transparent)
                if self.d3['image'] == 'pyimage7' and self.e2['image'] == 'pyimage1':
                    self.d3.configure(image=self.transparent)
                    self.e2.configure(image=self.transparent)
                if self.h3['image'] == 'pyimage7' and self.g2['image'] == 'pyimage1':
                    self.h3.configure(image=self.transparent)
                    self.g2.configure(image=self.transparent)
            self.piece = ''
            self.check = False
    ...
    def movef3(self):
        if not self.check:
            ...
            if self.piece == 'red':
                ...
                if self.g4['image'] == 'pyimage7':
                    self.g4.configure(image=self.transparent)
                if self.d5['image'] == 'pyimage7' and self.e4['image'] == 'pyimage1':
                    self.d5.configure(image=self.transparent)
                    self.e4.configure(image=self.transparent)
                if self.d1['image'] == 'pyimage7' and self.e2['image'] == 'pyimage1':
                    self.d1.configure(image=self.transparent)
                    self.e2.configure(image=self.transparent)
                if self.h5['image'] == 'pyimage7':
                    self.h5.configure(image=self.transparent)
                    self.g4.configure(image=self.transparent)
                if self.h1['image'] == 'pyimage7':
                    self.h1.configure(image=self.transparent)
                    self.g2.configure(image=self.transparent)
            self.piece = ''
            self.check = False
        ...
        if not self.check:
            ...
            if self.piece == 'red':
                ...
                if self.d3['image'] == 'pyimage7':
                    self.d3.configure(image=self.transparent)
                    self.e4.configure(image=self.transparent)
                if self.h7['image'] == 'pyimage7':
                    self.h7.configure(image=self.transparent)
                    self.g6.configure(image=self.transparent)
                if self.h3['image'] == 'pyimage7':
                    self.h3.configure(image=self.transparent)
                    self.g4.configure(image=self.transparent)
            elif self.piece == 'blackking':
