...
class Checkers(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.c2 = tk.Button(self, image=self.loadimage, width=32, height=35, background=black_sqr, command=self.movec2()).grid(row=2, column=1, sticky=tk.W)
    ...
    def movec2(self):
        if self.c2['bg'] == self.red_sqr:
            self.c2 = tk.Button(self, width=4, height=2, background=self.red_sqr).grid(row=2, column=1, sticky=tk.W)
