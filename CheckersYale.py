...
class Checkers(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.a2 = tk.Button(self, image=self.loadimage, width=32, height=35, background=self.black_sqr).grid(row=0, column=1, sticky=tk.W)
        self.a3 = tk.Button(self, width=4, height=2, background=self.red_sqr).grid(row=0, column=2, sticky=tk.W)
        self.a4 = tk.Button(self, image=self.loadimage, width=32, height=35, background=self.black_sqr).grid(row=0, column=3, sticky=tk.W)
        self.a5 = tk.Button(self, width=4, height=2, background=self.red_sqr).grid(row=0, column=4, sticky=tk.W)
        self.a6 = tk.Button(self, image=self.loadimage, width=32, height=35, background=self.black_sqr).grid(row=0, column=5, sticky=tk.W)
        self.a7 = tk.Button(self, width=4, height=2, background=self.red_sqr).grid(row=0, column=6, sticky=tk.W)
        self.a8 = tk.Button(self, image=self.loadimage, width=32, height=35, background=self.black_sqr).grid(row=0, column=7, sticky=tk.W)
